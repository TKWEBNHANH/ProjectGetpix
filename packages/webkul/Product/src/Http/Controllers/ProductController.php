...
class ProductController extends Controller
{
    ...
    public function update(ProductForm $request, $id)
    {
        ...
        print_r($_REQUEST['downloadable_links'][14]);
         
        //  echo $fileName =$_REQUEST['downloadable_links'][14]['file_name'];
        // echo $fileName =$_REQUEST['downloadable_links'][14]['file_name'];

         $path = Storage::disk('s3')->put('images/originals', $_REQUEST['downloadable_links'][14], 'public');
        $request->merge([
