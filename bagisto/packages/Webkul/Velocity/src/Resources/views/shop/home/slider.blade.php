@if (
    ...
    <div class="slider-container">
        <slider-component
            ...
            default-banner="{{ asset('/themes/velocity/assets/images/banner.webp.jpg) }}"
            ...
            @else
                <img class="col-12 no-padding banner-icon" src="{{ asset('/themes/velocity/assets/images/banner.webp.jpg') }}" alt=""/>
            @endif
